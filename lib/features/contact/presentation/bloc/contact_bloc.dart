...
class ContactBloc extends Bloc<ContactEvent, ContactState> {
  ...
  ContactBloc({required this.fetchContactsUsecase, required this.addContactUsecase, required this.checkCreateConversationUsecase}) : super(ContactInitial()){
  ...
  Future<void> _onCheckCreateConversation( CheckCreateConversation event, Emitter<ContactState> emit ) async {
    try {
      emit(ContactLoading());
      final conversationId = await checkCreateConversationUsecase(contactId: event.contactId);
